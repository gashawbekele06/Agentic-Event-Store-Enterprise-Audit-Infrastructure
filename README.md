...
Production-grade event sourcing infrastructure for multi-agent AI systems.
Built for the Apex Financial Services commercial loan processing scenario,
where four specialized AI agents collaborate on each application under
strict regulatory audit requirements.
...
└──────────┬──────────────────────────┬────────────┘
           ...
           ▼                          ▼
┌─────────────────┐     ┌──────────────────────────┐
│  events table   │     │  event_streams table      │
│  (append-only)  │     │  (version counter)        │
└─────────────────┘     └──────────────────────────┘
           │
           ▼
┌──────────────────────────────────────────────────┐
